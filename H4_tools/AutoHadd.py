...
def main():
    ...
    C2energies      = { '25GeV' : [], '50GeV' : [], '100GeV' : [], '150GeV' : [], '200GeV' : [], '250GeV' : [] }
    C3energies      = { '25GeV' : [], '50GeV' : [], '100GeV' : [], '150GeV' : [], '200GeV' : [], '250GeV' : [] }
    C4energies      = { '25GeV' : [], '50GeV' : [], '100GeV' : [], '150GeV' : [], '200GeV' : [], '250GeV' : [] }

    mastertable    = { 'C3up'  : C3upenergies, 'C3down' : C3downenergies, 'C3left' : C3leftenergies, 'C3right' : C3rightenergies, 'C2' : C2energies, 'C3' : C3energies, 'C4' : C4energies}
